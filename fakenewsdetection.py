...
Original file is located at
    https://colab.research.google.com/drive/1WBVsanWTm9tKJFlBS_ZMRTJB-JmsQrcf
"""

import numpy as np
import pandas as pd
df= pd.read_csv('Fake2.csv', nrows= 100)
df.head()
...
news = ["The Indian Space Research Organisation successfully launched a new satellite."]
